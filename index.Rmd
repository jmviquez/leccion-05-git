...
* Mejores prácticas para la escritura de mensajes en los commit: [How to Write a Git Commit Message](https://chris.beams.io/posts/git-commit/).
...
Otros comandos de Git de uso común son:
